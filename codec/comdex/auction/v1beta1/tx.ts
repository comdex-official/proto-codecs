...
function createBaseMsgPlaceSurplusBidRequest(): MsgPlaceSurplusBidRequest {
  return { auctionId: Long.UZERO, bidder: "", amount: undefined, appId: Long.UZERO, auctionMappingId: Long.UZERO };
}

export const MsgPlaceSurplusBidRequest = {
  encode(message: MsgPlaceSurplusBidRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  create<I extends Exact<DeepPartial<MsgPlaceSurplusBidRequest>, I>>(base?: I): MsgPlaceSurplusBidRequest {
    return MsgPlaceSurplusBidRequest.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgPlaceSurplusBidRequest>, I>>(object: I): MsgPlaceSurplusBidRequest {
    const message = createBaseMsgPlaceSurplusBidRequest();
...
export const MsgPlaceSurplusBidResponse = {
  encode(_: MsgPlaceSurplusBidResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
  ...
  create<I extends Exact<DeepPartial<MsgPlaceSurplusBidResponse>, I>>(base?: I): MsgPlaceSurplusBidResponse {
    return MsgPlaceSurplusBidResponse.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgPlaceSurplusBidResponse>, I>>(_: I): MsgPlaceSurplusBidResponse {
    const message = createBaseMsgPlaceSurplusBidResponse();
    return message;
  },
};
...
export const MsgPlaceDebtBidRequest = {
  encode(message: MsgPlaceDebtBidRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (!message.auctionId.isZero()) {
      writer.uint32(8).uint64(message.auctionId);
    }
    if (message.bidder !== "") {
  ...
  create<I extends Exact<DeepPartial<MsgPlaceDebtBidRequest>, I>>(base?: I): MsgPlaceDebtBidRequest {
    return MsgPlaceDebtBidRequest.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgPlaceDebtBidRequest>, I>>(object: I): MsgPlaceDebtBidRequest {
    const message = createBaseMsgPlaceDebtBidRequest();
    message.auctionId = (object.auctionId !== undefined && object.auctionId !== null)
      ? Long.fromValue(object.auctionId)
      : Long.UZERO;
...
export const MsgPlaceDebtBidResponse = {
  encode(_: MsgPlaceDebtBidResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
  ...
  create<I extends Exact<DeepPartial<MsgPlaceDebtBidResponse>, I>>(base?: I): MsgPlaceDebtBidResponse {
    return MsgPlaceDebtBidResponse.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgPlaceDebtBidResponse>, I>>(_: I): MsgPlaceDebtBidResponse {
    const message = createBaseMsgPlaceDebtBidResponse();
    return message;
  },
};
...
export const MsgPlaceDutchBidRequest = {
  encode(message: MsgPlaceDutchBidRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (!message.auctionId.isZero()) {
      writer.uint32(8).uint64(message.auctionId);
    }
    if (message.bidder !== "") {
  ...
  create<I extends Exact<DeepPartial<MsgPlaceDutchBidRequest>, I>>(base?: I): MsgPlaceDutchBidRequest {
    return MsgPlaceDutchBidRequest.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgPlaceDutchBidRequest>, I>>(object: I): MsgPlaceDutchBidRequest {
    const message = createBaseMsgPlaceDutchBidRequest();
    message.auctionId = (object.auctionId !== undefined && object.auctionId !== null)
      ? Long.fromValue(object.auctionId)
      : Long.UZERO;
...
export const MsgPlaceDutchBidResponse = {
  encode(_: MsgPlaceDutchBidResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
  ...
  create<I extends Exact<DeepPartial<MsgPlaceDutchBidResponse>, I>>(base?: I): MsgPlaceDutchBidResponse {
    return MsgPlaceDutchBidResponse.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgPlaceDutchBidResponse>, I>>(_: I): MsgPlaceDutchBidResponse {
    const message = createBaseMsgPlaceDutchBidResponse();
    return message;
  },
};
...
export const MsgPlaceDutchLendBidRequest = {
  encode(message: MsgPlaceDutchLendBidRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (!message.auctionId.isZero()) {
      writer.uint32(8).uint64(message.auctionId);
    }
    if (message.bidder !== "") {
  ...
  create<I extends Exact<DeepPartial<MsgPlaceDutchLendBidRequest>, I>>(base?: I): MsgPlaceDutchLendBidRequest {
    return MsgPlaceDutchLendBidRequest.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgPlaceDutchLendBidRequest>, I>>(object: I): MsgPlaceDutchLendBidRequest {
    const message = createBaseMsgPlaceDutchLendBidRequest();
    message.auctionId = (object.auctionId !== undefined && object.auctionId !== null)
      ? Long.fromValue(object.auctionId)
      : Long.UZERO;
...
export const MsgPlaceDutchLendBidResponse = {
  encode(_: MsgPlaceDutchLendBidResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
  ...
  create<I extends Exact<DeepPartial<MsgPlaceDutchLendBidResponse>, I>>(base?: I): MsgPlaceDutchLendBidResponse {
    return MsgPlaceDutchLendBidResponse.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgPlaceDutchLendBidResponse>, I>>(_: I): MsgPlaceDutchLendBidResponse {
    const message = createBaseMsgPlaceDutchLendBidResponse();
    return message;
  },
};
...
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || "comdex.auction.v1beta1.Msg";
    this.rpc = rpc;
  ...
  MsgPlaceSurplusBid(request: MsgPlaceSurplusBidRequest): Promise<MsgPlaceSurplusBidResponse> {
    ...
    const promise = this.rpc.request(this.service, "MsgPlaceSurplusBid", data);
    return promise.then((data) => MsgPlaceSurplusBidResponse.decode(new _m0.Reader(data)));
  }

  MsgPlaceDebtBid(request: MsgPlaceDebtBidRequest): Promise<MsgPlaceDebtBidResponse> {
    const data = MsgPlaceDebtBidRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "MsgPlaceDebtBid", data);
    return promise.then((data) => MsgPlaceDebtBidResponse.decode(new _m0.Reader(data)));
  }

  MsgPlaceDutchBid(request: MsgPlaceDutchBidRequest): Promise<MsgPlaceDutchBidResponse> {
    const data = MsgPlaceDutchBidRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "MsgPlaceDutchBid", data);
    return promise.then((data) => MsgPlaceDutchBidResponse.decode(new _m0.Reader(data)));
  }

  MsgPlaceDutchLendBid(request: MsgPlaceDutchLendBidRequest): Promise<MsgPlaceDutchLendBidResponse> {
    const data = MsgPlaceDutchLendBidRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "MsgPlaceDutchLendBid", data);
    return promise.then((data) => MsgPlaceDutchLendBidResponse.decode(new _m0.Reader(data)));
  }
}
