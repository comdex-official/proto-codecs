...
function createBaseAuctionHistorical(): AuctionHistorical {
  return { auctionId: Long.UZERO, auctionHistorical: undefined, lockedVault: undefined };
}

export const AuctionHistorical = {
  encode(message: AuctionHistorical, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (!message.auctionId.isZero()) {
      writer.uint32(8).uint64(message.auctionId);
    }
    if (message.auctionHistorical !== undefined) {
      Auction.encode(message.auctionHistorical, writer.uint32(18).fork()).ldelim();
    }
    if (message.lockedVault !== undefined) {
      LockedVault.encode(message.lockedVault, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): AuctionHistorical {
    return {
      ...
      auctionHistorical: isSet(object.auctionHistorical) ? Auction.fromJSON(object.auctionHistorical) : undefined,
      lockedVault: isSet(object.lockedVault) ? LockedVault.fromJSON(object.lockedVault) : undefined,
    };
  },
  ...
  toJSON(message: AuctionHistorical): unknown {
    ...
    message.auctionHistorical !== undefined &&
      (obj.auctionHistorical = message.auctionHistorical ? Auction.toJSON(message.auctionHistorical) : undefined);
    message.lockedVault !== undefined &&
      (obj.lockedVault = message.lockedVault ? LockedVault.toJSON(message.lockedVault) : undefined);
    return obj;
  },

  create<I extends Exact<DeepPartial<AuctionHistorical>, I>>(base?: I): AuctionHistorical {
    return AuctionHistorical.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<AuctionHistorical>, I>>(object: I): AuctionHistorical {
    const message = createBaseAuctionHistorical();
...
export const Auction = {
  ...
  fromPartial<I extends Exact<DeepPartial<Auction>, I>>(object: I): Auction {
    ...
    message.collateralTokenAuctionPrice = object.collateralTokenAuctionPrice ?? "";
    message.collateralTokenOraclePrice = object.collateralTokenOraclePrice ?? "";
    ...
    message.collateralTokenInitialPrice = object.collateralTokenInitialPrice ?? "";
    return message;
  },
};
...
function createBaseLimitBidProtocolData(): LimitBidProtocolData {
  return { collateralAssetId: Long.UZERO, debtAssetId: Long.UZERO, bidValue: "", maxDiscount: "" };
}

export const LimitBidProtocolData = {
  encode(message: LimitBidProtocolData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (!message.collateralAssetId.isZero()) {
  ...
  create<I extends Exact<DeepPartial<LimitBidProtocolData>, I>>(base?: I): LimitBidProtocolData {
    return LimitBidProtocolData.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<LimitBidProtocolData>, I>>(object: I): LimitBidProtocolData {
    const message = createBaseLimitBidProtocolData();
    message.collateralAssetId = (object.collateralAssetId !== undefined && object.collateralAssetId !== null)
      ? Long.fromValue(object.collateralAssetId)
      : Long.UZERO;
...
export const LimitBidProtocolDataForQuery = {
  encode(message: LimitBidProtocolDataForQuery, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (!message.collateralAssetId.isZero()) {
      writer.uint32(8).uint64(message.collateralAssetId);
    }
    if (!message.debtAssetId.isZero()) {
  ...
  create<I extends Exact<DeepPartial<LimitBidProtocolDataForQuery>, I>>(base?: I): LimitBidProtocolDataForQuery {
    return LimitBidProtocolDataForQuery.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<LimitBidProtocolDataForQuery>, I>>(object: I): LimitBidProtocolDataForQuery {
    const message = createBaseLimitBidProtocolDataForQuery();
    message.collateralAssetId = (object.collateralAssetId !== undefined && object.collateralAssetId !== null)
      ? Long.fromValue(object.collateralAssetId)
      : Long.UZERO;
...
function createBaseLimitBidProtocolDataWithUserForQuery(): LimitBidProtocolDataWithUserForQuery {
  return {
    collateralAssetId: Long.UZERO,
    debtAssetId: Long.UZERO,
    bidValue: "",
...
export const LimitBidProtocolDataWithUserForQuery = {
  encode(message: LimitBidProtocolDataWithUserForQuery, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (!message.collateralAssetId.isZero()) {
      writer.uint32(8).uint64(message.collateralAssetId);
    }
    if (!message.debtAssetId.isZero()) {
  ...
  create<I extends Exact<DeepPartial<LimitBidProtocolDataWithUserForQuery>, I>>(
    base?: I,
  ): LimitBidProtocolDataWithUserForQuery {
    return LimitBidProtocolDataWithUserForQuery.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<LimitBidProtocolDataWithUserForQuery>, I>>(
    object: I,
  ): LimitBidProtocolDataWithUserForQuery {
    const message = createBaseLimitBidProtocolDataWithUserForQuery();
    message.collateralAssetId = (object.collateralAssetId !== undefined && object.collateralAssetId !== null)
    ...
    message.collateralAssetDenom = object.collateralAssetDenom ?? "";
    message.debtAssetDenom = object.debtAssetDenom ?? "";
    message.userBidValue = object.userBidValue ?? "";
    return message;
  },
};
