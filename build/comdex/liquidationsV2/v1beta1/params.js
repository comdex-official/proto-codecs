...
function createBaseParams() {
    return { liquidationBatchSize: long_1.default.UZERO };
}
exports.Params = {
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.liquidationBatchSize = reader.uint64();
                    break;
                default:
    ...
    fromJSON(object) {
        return {
            liquidationBatchSize: isSet(object.liquidationBatchSize)
                ? long_1.default.fromValue(object.liquidationBatchSize)
    ...
    toJSON(message) {
        ...
        message.liquidationBatchSize !== undefined &&
            (obj.liquidationBatchSize = (message.liquidationBatchSize || long_1.default.UZERO).toString());
        return obj;
    },
    fromPartial(object) {
        const message = createBaseParams();
