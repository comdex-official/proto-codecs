...
function createBaseQueryVaultOfOwnerByPairRequest() {
    return {
...
exports.QueryVaultOfOwnerByPairRequest = {
    encode(message, writer = _m0.Writer.create()) {
...
function createBaseQueryVaultOfOwnerByPairResponse() {
    return { vaultId: "" };
}
exports.QueryVaultOfOwnerByPairResponse = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.vaultId !== "") {
...
class QueryServiceClientImpl {
    ...
    QueryVaultOfOwnerByPair(request) {
        const data = exports.QueryVaultOfOwnerByPairRequest.encode(request).finish();
        const promise = this.rpc.request("comdex.vault.v1beta1.QueryService", "QueryVaultOfOwnerByPair", data);
        return promise.then((data) => exports.QueryVaultOfOwnerByPairResponse.decode(new _m0.Reader(data)));
    }
