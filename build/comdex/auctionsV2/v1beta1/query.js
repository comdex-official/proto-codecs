...
exports.QueryClientImpl = exports.QueryAuctionsHistoryResponse = exports.QueryAuctionsHistoryRequest = exports.QueryBidsFilterResponse = exports.QueryBidsFilterRequest = exports.QueryLimitBidProtocolDataWithUserResponse = exports.QueryLimitBidProtocolDataWithUserRequest = exports.QueryAuctionFeesCollectionFromLimitBidTxResponse = exports.QueryAuctionFeesCollectionFromLimitBidTxRequest = exports.QueryLimitBidProtocolDataResponse = exports.QueryLimitBidProtocolDataRequest = exports.QueryLimitBidsResponse = exports.QueryLimitBidsRequest = exports.QueryUserLimitBidsByAssetIDResponse = exports.QueryUserLimitBidsByAssetIDRequest = exports.QueryAuctionParamsResponse = exports.QueryAuctionParamsRequest = exports.QueryBidResponse = exports.QueryBidRequest = exports.QueryBidsResponse = exports.QueryBidsRequest = exports.QueryAuctionsResponse = exports.QueryAuctionsRequest = exports.QueryAuctionResponse = exports.QueryAuctionRequest = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.QueryAuctionRequest = {
    ...
    create(base) {
        return exports.QueryAuctionRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryAuctionRequest();
...
exports.QueryAuctionResponse = {
    ...
    fromJSON(object) {
        return { auction: isSet(object.auction) ? auction_1.Auction.fromJSON(object.auction) : undefined };
    },
    toJSON(message) {
        const obj = {};
        message.auction !== undefined && (obj.auction = message.auction ? auction_1.Auction.toJSON(message.auction) : undefined);
        return obj;
    },
    create(base) {
        return exports.QueryAuctionResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseQueryAuctionResponse();
...
exports.QueryAuctionsRequest = {
    ...
    fromJSON(object) {
        return {
            auctionType: isSet(object.auctionType) ? long_1.default.fromValue(object.auctionType) : long_1.default.UZERO,
            history: isSet(object.history) ? Boolean(object.history) : false,
    ...
    toJSON(message) {
        const obj = {};
        message.auctionType !== undefined && (obj.auctionType = (message.auctionType || long_1.default.UZERO).toString());
        message.history !== undefined && (obj.history = message.history);
    ...
    create(base) {
        return exports.QueryAuctionsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryAuctionsRequest();
...
exports.QueryAuctionsResponse = {
    ...
    fromJSON(object) {
        return {
            auctions: Array.isArray(object === null || object === void 0 ? void 0 : object.auctions) ? object.auctions.map((e) => auction_1.Auction.fromJSON(e)) : [],
    ...
    create(base) {
        return exports.QueryAuctionsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryAuctionsResponse();
        message.auctions = ((_a = object.auctions) === null || _a === void 0 ? void 0 : _a.map((e) => auction_1.Auction.fromPartial(e))) || [];
        message.pagination = (object.pagination !== undefined && object.pagination !== null)
...
function createBaseQueryBidsRequest() {
    return { bidder: "", bidType: long_1.default.UZERO, history: false, pagination: undefined };
}
exports.QueryBidsRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            bidType: isSet(object.bidType) ? long_1.default.fromValue(object.bidType) : long_1.default.UZERO,
            history: isSet(object.history) ? Boolean(object.history) : false,
            pagination: isSet(object.pagination) ? pagination_1.PageRequest.fromJSON(object.pagination) : undefined,
        };
    },
    toJSON(message) {
        ...
        message.bidType !== undefined && (obj.bidType = (message.bidType || long_1.default.UZERO).toString());
        message.history !== undefined && (obj.history = message.history);
        message.pagination !== undefined &&
            (obj.pagination = message.pagination ? pagination_1.PageRequest.toJSON(message.pagination) : undefined);
        return obj;
...
exports.QueryBidsResponse = {
    ...
    fromJSON(object) {
        return {
            bidder: isSet(object.bidder) ? String(object.bidder) : "",
            bids: Array.isArray(object === null || object === void 0 ? void 0 : object.bids) ? object.bids.map((e) => bid_1.Bid.fromJSON(e)) : [],
            pagination: isSet(object.pagination) ? pagination_1.PageResponse.fromJSON(object.pagination) : undefined,
        };
    },
    toJSON(message) {
...
function createBaseQueryBidRequest() {
    return { bidId: long_1.default.UZERO };
}
exports.QueryBidRequest = {
    ...
    fromJSON(object) {
        return { bidId: isSet(object.bidId) ? long_1.default.fromValue(object.bidId) : long_1.default.UZERO };
    },
    toJSON(message) {
        const obj = {};
        message.bidId !== undefined && (obj.bidId = (message.bidId || long_1.default.UZERO).toString());
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        const message = createBaseQueryBidRequest();
        message.bidId = (object.bidId !== undefined && object.bidId !== null) ? long_1.default.fromValue(object.bidId) : long_1.default.UZERO;
        return message;
    },
};
...
exports.QueryBidResponse = {
    ...
    fromJSON(object) {
        return { bid: isSet(object.bid) ? bid_1.Bid.fromJSON(object.bid) : undefined };
    },
    toJSON(message) {
        const obj = {};
...
exports.QueryAuctionParamsResponse = {
    ...
    fromJSON(object) {
        return { auctionParams: isSet(object.auctionParams) ? bid_1.AuctionParams.fromJSON(object.auctionParams) : undefined };
    },
    toJSON(message) {
        const obj = {};
...
function createBaseQueryUserLimitBidsByAssetIDRequest() {
    return { bidder: "", collateralTokenId: long_1.default.UZERO, debtTokenId: long_1.default.UZERO, pagination: undefined };
}
exports.QueryUserLimitBidsByAssetIDRequest = {
    ...
    create(base) {
        return exports.QueryUserLimitBidsByAssetIDRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryUserLimitBidsByAssetIDRequest();
...
exports.QueryUserLimitBidsByAssetIDResponse = {
    ...
    create(base) {
        return exports.QueryUserLimitBidsByAssetIDResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseQueryUserLimitBidsByAssetIDResponse();
        ...
        message.limitOrderBids = ((_c = object.limitOrderBids) === null || _c === void 0 ? void 0 : _c.map((e) => bid_1.LimitOrderBid.fromPartial(e))) || [];
        message.pagination = (object.pagination !== undefined && object.pagination !== null)
            ? pagination_1.PageResponse.fromPartial(object.pagination)
            : undefined;
        return message;
...
function createBaseQueryLimitBidsRequest() {
    return { collateralTokenId: long_1.default.UZERO, debtTokenId: long_1.default.UZERO, pagination: undefined };
}
exports.QueryLimitBidsRequest = {
    ...
    create(base) {
        return exports.QueryLimitBidsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseQueryLimitBidsRequest();
        message.collateralTokenId = (object.collateralTokenId !== undefined && object.collateralTokenId !== null)
...
exports.QueryLimitBidsResponse = {
    ...
    create(base) {
        return exports.QueryLimitBidsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryLimitBidsResponse();
        message.limitOrderBids = ((_a = object.limitOrderBids) === null || _a === void 0 ? void 0 : _a.map((e) => bid_1.LimitOrderBid.fromPartial(e))) || [];
        message.pagination = (object.pagination !== undefined && object.pagination !== null)
            ? pagination_1.PageResponse.fromPartial(object.pagination)
            : undefined;
        return message;
...
exports.QueryLimitBidProtocolDataRequest = {
    ...
    create(base) {
        return exports.QueryLimitBidProtocolDataRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseQueryLimitBidProtocolDataRequest();
        message.pagination = (object.pagination !== undefined && object.pagination !== null)
...
exports.QueryLimitBidProtocolDataResponse = {
    ...
    create(base) {
        return exports.QueryLimitBidProtocolDataResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryLimitBidProtocolDataResponse();
...
exports.QueryAuctionFeesCollectionFromLimitBidTxRequest = {
    ...
    create(base) {
        return exports.QueryAuctionFeesCollectionFromLimitBidTxRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseQueryAuctionFeesCollectionFromLimitBidTxRequest();
        message.pagination = (object.pagination !== undefined && object.pagination !== null)
...
exports.QueryAuctionFeesCollectionFromLimitBidTxResponse = {
    ...
    create(base) {
        return exports.QueryAuctionFeesCollectionFromLimitBidTxResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryAuctionFeesCollectionFromLimitBidTxResponse();
...
exports.QueryLimitBidProtocolDataWithUserRequest = {
    ...
    create(base) {
        return exports.QueryLimitBidProtocolDataWithUserRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryLimitBidProtocolDataWithUserRequest();
...
exports.QueryLimitBidProtocolDataWithUserResponse = {
    ...
    toJSON(message) {
        ...
        if (message.limitBidProtocolDataWithUser) {
            obj.limitBidProtocolDataWithUser = message.limitBidProtocolDataWithUser.map((e) => e ? auction_1.LimitBidProtocolDataWithUserForQuery.toJSON(e) : undefined);
        }
        else {
    ...
    create(base) {
        return exports.QueryLimitBidProtocolDataWithUserResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryLimitBidProtocolDataWithUserResponse();
...
exports.QueryBidsFilterRequest = {
    ...
    create(base) {
        return exports.QueryBidsFilterRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseQueryBidsFilterRequest();
...
exports.QueryBidsFilterResponse = {
    ...
    create(base) {
        return exports.QueryBidsFilterResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseQueryBidsFilterResponse();
...
function createBaseQueryAuctionsHistoryRequest() {
    return { auctionType: long_1.default.UZERO, pagination: undefined };
}
exports.QueryAuctionsHistoryRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (!message.auctionType.isZero()) {
            writer.uint32(8).uint64(message.auctionType);
        }
    ...
    create(base) {
        return exports.QueryAuctionsHistoryRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseQueryAuctionsHistoryRequest();
        message.auctionType = (object.auctionType !== undefined && object.auctionType !== null)
...
function createBaseQueryAuctionsHistoryResponse() {
    return { auctions: [], pagination: undefined };
}
exports.QueryAuctionsHistoryResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.auctions) {
            auction_1.AuctionHistorical.encode(v, writer.uint32(10).fork()).ldelim();
        }
        if (message.pagination !== undefined) {
            pagination_1.PageResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.auctions.push(auction_1.AuctionHistorical.decode(reader, reader.uint32()));
                    break;
                case 2:
                    message.pagination = pagination_1.PageResponse.decode(reader, reader.uint32());
                    break;
    ...
    fromJSON(object) {
        return {
            auctions: Array.isArray(object === null || object === void 0 ? void 0 : object.auctions) ? object.auctions.map((e) => auction_1.AuctionHistorical.fromJSON(e)) : [],
            pagination: isSet(object.pagination) ? pagination_1.PageResponse.fromJSON(object.pagination) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.auctions) {
            obj.auctions = message.auctions.map((e) => e ? auction_1.AuctionHistorical.toJSON(e) : undefined);
        }
        else {
            obj.auctions = [];
        }
    ...
    create(base) {
        return exports.QueryAuctionsHistoryResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryAuctionsHistoryResponse();
        message.auctions = ((_a = object.auctions) === null || _a === void 0 ? void 0 : _a.map((e) => auction_1.AuctionHistorical.fromPartial(e))) || [];
        message.pagination = (object.pagination !== undefined && object.pagination !== null)
            ? pagination_1.PageResponse.fromPartial(object.pagination)
            : undefined;
        return message;
...
class QueryClientImpl {
    constructor(rpc, opts) {
        this.service = (opts === null || opts === void 0 ? void 0 : opts.service) || "comdex.auctionsV2.v1beta1.Query";
        this.rpc = rpc;
    ...
    AuctionParams(request) {
        ...
        return promise.then((data) => exports.QueryAuctionParamsResponse.decode(new minimal_1.default.Reader(data)));
    }
    UserLimitBidsByAssetID(request) {
        ...
        return promise.then((data) => exports.QueryUserLimitBidsByAssetIDResponse.decode(new minimal_1.default.Reader(data)));
    }
    LimitBids(request) {
        const data = exports.QueryLimitBidsRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "LimitBids", data);
        return promise.then((data) => exports.QueryLimitBidsResponse.decode(new minimal_1.default.Reader(data)));
    }
    LimitBidProtocolData(request) {
        ...
        return promise.then((data) => exports.QueryLimitBidProtocolDataResponse.decode(new minimal_1.default.Reader(data)));
    }
    AuctionFeesCollectionData(request) {
        ...
        return promise.then((data) => exports.QueryAuctionFeesCollectionFromLimitBidTxResponse.decode(new minimal_1.default.Reader(data)));
    }
    LimitBidProtocolDataWithUser(request) {
        ...
        return promise.then((data) => exports.QueryLimitBidProtocolDataWithUserResponse.decode(new minimal_1.default.Reader(data)));
    }
    BidsFilter(request) {
        ...
        return promise.then((data) => exports.QueryBidsFilterResponse.decode(new minimal_1.default.Reader(data)));
    }
    AuctionsHistory(request) {
        const data = exports.QueryAuctionsHistoryRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "AuctionsHistory", data);
        return promise.then((data) => exports.QueryAuctionsHistoryResponse.decode(new minimal_1.default.Reader(data)));
    }
}
