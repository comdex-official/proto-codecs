...
exports.Bid = {
    ...
    fromJSON(object) {
        return {
            biddingId: isSet(object.biddingId) ? long_1.default.fromValue(object.biddingId) : long_1.default.UZERO,
            ...
            collateralTokenAmount: isSet(object.collateralTokenAmount)
                ...
                : undefined,
            debtTokenAmount: isSet(object.debtTokenAmount) ? coin_1.Coin.fromJSON(object.debtTokenAmount) : undefined,
    ...
    toJSON(message) {
        const obj = {};
        message.biddingId !== undefined && (obj.biddingId = (message.biddingId || long_1.default.UZERO).toString());
        ...
        message.debtTokenAmount !== undefined &&
            (obj.debtTokenAmount = message.debtTokenAmount ? coin_1.Coin.toJSON(message.debtTokenAmount) : undefined);
...
exports.LimitOrderBid = {
    ...
    fromJSON(object) {
        return {
            limitOrderBiddingId: isSet(object.limitOrderBiddingId) ? long_1.default.fromValue(object.limitOrderBiddingId) : long_1.default.UZERO,
            bidderAddress: isSet(object.bidderAddress) ? String(object.bidderAddress) : "",
            ...
            biddingId: Array.isArray(object === null || object === void 0 ? void 0 : object.biddingId) ? object.biddingId.map((e) => long_1.default.fromValue(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    create(base) {
        return exports.LimitOrderBid.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseLimitOrderBid();
...
exports.AuctionParams = {
    ...
    fromJSON(object) {
        return {
            ...
            minUsdValueLeft: isSet(object.minUsdValueLeft) ? long_1.default.fromValue(object.minUsdValueLeft) : long_1.default.UZERO,
    ...
    toJSON(message) {
        ...
        message.minUsdValueLeft !== undefined && (obj.minUsdValueLeft = (message.minUsdValueLeft || long_1.default.UZERO).toString());
    ...
    create(base) {
        return exports.AuctionParams.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
exports.LimitOrderBidsForUser = {
    ...
    create(base) {
        return exports.LimitOrderBidsForUser.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseLimitOrderBidsForUser();
        message.bidderAddress = (_a = object.bidderAddress) !== null && _a !== void 0 ? _a : "";
        message.limitOrderBidKey = ((_b = object.limitOrderBidKey) === null || _b === void 0 ? void 0 : _b.map((e) => exports.LimitOrderUserKey.fromPartial(e))) || [];
        return message;
    },
};
...
exports.LimitOrderUserKey = {
    ...
    create(base) {
        return exports.LimitOrderUserKey.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseLimitOrderUserKey();
...
exports.AuctionFeesCollectionFromLimitBidTx = {
    ...
    fromJSON(object) {
        return {
            assetId: isSet(object.assetId) ? long_1.default.fromValue(object.assetId) : long_1.default.UZERO,
            amount: isSet(object.amount) ? String(object.amount) : "",
        };
    },
    toJSON(message) {
        const obj = {};
        message.assetId !== undefined && (obj.assetId = (message.assetId || long_1.default.UZERO).toString());
        message.amount !== undefined && (obj.amount = message.amount);
        return obj;
    },
    create(base) {
        return exports.AuctionFeesCollectionFromLimitBidTx.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseAuctionFeesCollectionFromLimitBidTx();
